            ...
            <div class="lg:col-span-7">
                <div class="lg:ms-5">
                    ...
                    <p class="text-slate-400 max-w-xl text-[15px]">
                        از 8 سال گذشته من در حال مطالعه و پیاده سازی پروژه های مختلف بودم , این تجربیات به من امکان می‌دهد که با دقت و دانش عمیق تر به پروژه‌ها پرداخته و از کیفیت برتری برخوردار شوند. این تجربیات مرا توانمند کرده‌اند که کمتر با مشکلات فنی و باگ‌ها مواجه شوم.
                    </p>
